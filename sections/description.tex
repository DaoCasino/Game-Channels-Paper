...
\begin{tabular}{ccc}
	...
	$0xde8456...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underleftarrow{\quad (0xde8456...,  100, 0x87ff5a..., \quad $ \\  $ \quad 5000,  gameData,  openingBlock,\quad $ \\  $ \quad RSAfingerprint,0x8a4654.., Bob\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0xde8456...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (0xde8456...,  100, 0x87ff5a..., \quad $ \\  $ \quad 5000,  gameData,  openingBlock,\quad $ \\  $ \quad RSAfingerprint,0x8a4654.., Alice\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0x87ff5a...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (0xde8456...,  100, 0x87ff5a..., \quad $ \\  $ \quad 5000,  gameData,  openingBlock,\quad $ \\  $ \quad RSAfingerprint,0x8a4654.., Bob\_signature, \quad $ \\  $ \quad Alice\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Contract:\\
	$0x8a4654...$\\
...
\begin{tabular}{ccc}
	...
	$0xde8456...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId, 10, 1, gameData, qw2ert5t,\quad $ \\  $ \quad Alice\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0xde8456...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underleftarrow{\quad (14, 0x5f43c..., 1, gameData, 110, 4990, Bob\_signature) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\end{lstlisting}
where $player_signed_message = ECDSA.Sign(channelId, round, \\ playerBalance, gameData, seed)$.
...
\begin{tabular}{ccc}
	...
	$0xde8456...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId, 85, 5015, 375, n, true, \quad $ \\  $ \quad Alice\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0x87ff5a...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId, 85, 5015, 375, n,  true,\quad $ \\  $ \quad Bob\_signature,\quad $ \\  $ \quad Alice\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Contract:\\
	$0x8a4654...$\\
...
\begin{tabular}{ccc}
	...
	$0xca62a232...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underleftarrow{\quad (20, 0x5ааа3c..., 1, gameData, 3, 502, Bob\_signature) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0xca62a232...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId, 7, 498, 1, gameData) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
