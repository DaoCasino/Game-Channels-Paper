...
\begin{tabular}{ccc}
	...
	$0xde8456...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId,0xde8456...,  100, 0x87ff5a..., \quad $ \\  $ \quad 5000,  gameData,  openingBlock,\quad $ \\  $ \quad RSAfingerprint, Alice\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0x87ff5a...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId,0xde8456...,  100, 0x87ff5a..., \quad $ \\  $ \quad 5000,  gameData,  openingBlock,\quad $ \\  $ \quad RSAfingerprint, Bob\_signature, \quad $ \\  $ \quad Alice\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Contract:\\
	$0x8a4654...$\\
