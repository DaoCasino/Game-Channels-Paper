...
\begin{tabular}{ccc}
	...
	$0xde8456...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underleftarrow{\quad (channelId, 85, 5015, gameData, n) \ \ \ \  \ \  \quad \quad \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0xde8456...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId, 85, 5015, gameData, n, true, \quad \quad \quad $ \\  $ \quad Alice\_signature ) \quad \quad \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0x87ff5a...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId, 85, 5015, gameData, n,  true,\quad \quad \quad $ \\  $ \quad Bob\_signature, Alice\_signature ) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Contract:\\
	$0x8a4654...$\\
...
\begin{tabular}{ccc}
	...
	$0xca62a232...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underleftarrow{\quad (20, 0x5ааа3c..., channelId, 3, 502, gameData, 1,\quad \quad $ \\  $ \quad Bob\_signature) \quad}$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
...
\begin{tabular}{ccc}
	...
	$0xca62a232...$\\
   	\end{tabular} &
   \begin{tabular}{c}
   $\underrightarrow{\quad (channelId, 7, 498, gameData, 1,\quad $\\$ \quad Malory\_signature)\quad  \quad \ \ }$
   \end{tabular}&
  	 \begin{tabular}{cl}
 	 Bob:\\
	$0x87ff5a...$\\
