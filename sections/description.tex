...
Контракт дает время в $t1+t2$ блоков Бобу загрузить более новое состояние игры в канал. После прохождения $t1 - 1$ блоков Боб восстанавливает соединение и успевает загрузить новое состояние с результатами игры в канал при помощи функции $updateChannel$. Диспут стирается, и Алиса с Бобом продолжают играть.
...
\\
 ...
 Алиса проверяет полученное сообщение, составляет ответ с данными для завершения игры и отправляет его вместе с подписью Бобу.
\\
\\
\begin{tabular}{ccc}
   	\begin{tabular}{c}
